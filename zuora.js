...
const invoiceApplicationParts = require('./lib/invoiceApplicationParts.js');
...
const refunds = require('./lib/refunds.js');
...
function Zuora(config) {
  ...
  this.invoiceApplicationParts = invoiceApplicationParts(this);
