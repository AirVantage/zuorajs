...
module.exports = function(zuoraClient) {
  ...
  function cancelSubscription(subscriptionId, subscriptionCancelRequest) {
    return zuoraClient.authenticate().then(headers => {
      const url = zuoraClient.serverUrl + '/v1/subscriptions/' + subscriptionId + '/cancel';
      const query = {
  ...
  return {
    ...
    cancel: (subscriptionId, subscriptionCancelRequest) => cancelSubscription(subscriptionId, subscriptionCancelRequest)
  };
};
